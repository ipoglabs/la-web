...
/** Mirrors register/google-complete/GoogleCompleteForm.tsx exactly. */
export default function AppleCompleteForm({ appleData }: Props) {
        ...
        <Card className="shadow-[0_0_12px_rgba(0,0,0,0.45)] border-gray-200 rounded-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              {/* Apple account (readonly) */}
              <Field>
                <FieldLabel>Apple account</FieldLabel>
