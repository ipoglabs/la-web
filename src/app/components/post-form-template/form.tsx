// src/app/components/post-form-template/form.tsx
"use client";

import { useState } from "react";
import LocationPickerMap from "../LocationPickerMap";
import { addPostAction } from "@/app/actions/addPostAction"; // <-- use wrapper
...
export default function PostFormTemplate({ category, subcategory }: Props) {
  ...
  return (
    <form
      ...
      className="space-y-6"
      action={addPostAction}  // <-- wrapper returns Promise<void>
    >
      ...
      <div className="mb-20">
        ...
        {location && <p className="mt-2 text-sm text-gray-600">Selected: {location.address}</p>}
      </div>
