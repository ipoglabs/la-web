  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // ✅ use your existing API route: /api/post-details/[id]
        const res = await fetch(
          `/api/post-details/${encodeURIComponent(postId)}`,
          {
            method: "GET",
            cache: "no-store",
          }
        ...
        // your route returns the post directly, not { post: ... }
        const p: PostData = json as PostData;
