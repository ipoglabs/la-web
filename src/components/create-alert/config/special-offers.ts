      ...
      filters: [
        {
          ...
          options: [
            ...
            { label: "Balance Transfer", value: "balance"    },
          ],
        },
        {
          id: "fin_provider",
          ...
          options: [
            ...
            { label: "Digital Wallet", value: "ewallet"    },
            { label: "Insurance Co.",  value: "insurance"  },
        ...
        },
        {
          ...
          type: "toggle",
          options: [
            { label: "Daily Spending", value: "spending" },
