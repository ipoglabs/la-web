...
export const DESIGN_SYSTEM_MENU: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Phone OTP", href: "/design-system/uxcomp/phone-otp" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Private Profile", href: "/snippets/private-profile" },
      { label: "Public Profile", href: "/snippets/public-profile" },
      { label: "Chat", href: "/snippets/chat" },
      ...
      { label: "Delete Account", href: "/snippets/delete-account" },
