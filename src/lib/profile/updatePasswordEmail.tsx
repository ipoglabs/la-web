...
export async function sendPasswordUpdateEmail(data: {
  firstName: string;
  lastName: string;
  email: string;
}) {
    ...
    <tr>
      <td style="padding:10px 20px;">
        ...
        <p style="font-size:14px;color:#d32f2f;margin-top:15px;">
          ⚠️ If you did not perform this action, please reset your password immediately and contact support.
        </p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:20px;">
        <a href="${appUrl}/profile"
          style="display:inline-block;background:#dc2626;color:white;padding:12px 18px;
